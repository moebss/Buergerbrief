      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8 text-center mt-[-4vh]">
        ...
        >
          ...
          <motion.p
            ...
            className="mt-6 text-xl md:text-2xl text-gray-200 max-w-2xl mx-auto font-light leading-relaxed"
          >
          ...
          <div className="mt-12 flex flex-col sm:flex-row gap-6 justify-center items-center">
            <motion.a
              ...
              whileTap={{ scale: 0.95 }}
              className="group inline-flex items-center justify-center w-full sm:w-auto px-10 py-5 text-xl font-bold rounded-2xl text-white bg-rek-magenta transition-all"
            >
